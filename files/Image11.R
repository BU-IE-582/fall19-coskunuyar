...
library(wvtool)
library("matrixStats")
imgActual <- readJPEG("C:/Fabric11-ConvertImage.jpg")
img1 <- readJPEG("C:/Fabric11-ConvertImage.jpg")

gaborFilter <- gabor.filter(x=imgActual, lamda=25, theta=90, bw=3, phi=0, asp=0.45, disp=TRUE)
