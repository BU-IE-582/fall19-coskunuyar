...
library(wvtool)
library("matrixStats")
imgActual <- readJPEG("C:/Fabric12-ConvertImage.jpg")
img1 <- readJPEG("C:/Fabric12-ConvertImage.jpg")

gaborFilter <- gabor.filter(x=imgActual, lamda=10, theta=0, bw=8, phi=0, asp=0.8, disp=TRUE)
