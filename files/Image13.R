...
library(wvtool)
library("matrixStats")
imgActual <- readJPEG("C:/Fabric13-ConvertImage.jpg")
img1 <- readJPEG("C:/Fabric13-ConvertImage.jpg")

gaborFilter <- gabor.filter(x=imgActual, lamda=20, theta=60, bw=5, phi=0, asp=0.6, disp=TRUE)
