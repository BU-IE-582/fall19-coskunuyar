...
library(wvtool)
library("matrixStats")
imgActual <- readJPEG("C:/Fabric14-ConvertImage.jpg")
img1 <- readJPEG("C:/Fabric14-ConvertImage.jpg")

gaborFilter <- gabor.filter(x=imgActual, lamda=20, theta=0, bw=4, phi=0, asp=0.5, disp=TRUE)
