...
library(wvtool)
library("matrixStats")
imgActual <- readJPEG("C:/Fabric15-ConvertImage.jpg")
img1 <- readJPEG("C:/Fabric15-ConvertImage.jpg")

gaborFilter <- gabor.filter(x=imgActual, lamda=10, theta=90, bw=5, phi=0, asp=0.5, disp=TRUE)
