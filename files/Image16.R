...
library(wvtool)
library("matrixStats")
imgActual <- readJPEG("C:/Fabric16-ConvertImage.jpg")
img1 <- readJPEG("C:/Fabric16-ConvertImage.jpg")

gaborFilter <- gabor.filter(x=imgActual, lamda=5, theta=30, bw=5, phi=0, asp=0.6, disp=TRUE)
