...
library(wvtool)
library("matrixStats")
imgActual <- readJPEG("C:/Fabric17-ConvertImage.jpg")
img1 <- readJPEG("C:/Fabric17-ConvertImage.jpg")

gaborFilter <- gabor.filter(x=imgActual, lamda=15, theta=45, bw=7, phi=0, asp=0.7, disp=TRUE)
