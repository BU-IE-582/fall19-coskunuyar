...
library(wvtool)
library("matrixStats")
imgActual <- readJPEG("C:/Fabric18-ConvertImage.jpg")
img1 <- readJPEG("C:/Fabric18-ConvertImage.jpg")

gaborFilter <- gabor.filter(x=imgActual, lamda=15, theta=30, bw=5, phi=0, asp=0.7, disp=TRUE)
