...
library(wvtool)
library("matrixStats")
imgActual <- readJPEG("C:/Fabric2-ConvertImage.jpg")
img1 <- readJPEG("C:/Fabric2-ConvertImage.jpg")

gaborFilter <- gabor.filter(x=imgActual, lamda=10, theta=15, bw=2.5, phi=0, asp=0.3, disp=TRUE)
