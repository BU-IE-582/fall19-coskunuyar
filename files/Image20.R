...
library(wvtool)
library("matrixStats")
imgActual <- readJPEG("C:/Fabric20-ConvertImage.jpg")
img1 <- readJPEG("C:/Fabric20-ConvertImage.jpg")

gaborFilter <- gabor.filter(x=imgActual, lamda=18, theta=30, bw=4, phi=0, asp=0.9, disp=TRUE)
