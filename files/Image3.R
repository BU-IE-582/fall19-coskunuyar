...
library(wvtool)
library("matrixStats")
imgActual <- readJPEG("C:/Fabric3-ConvertImage.jpg")
img1 <- readJPEG("C:/Fabric3-ConvertImage.jpg")

gaborFilter <- gabor.filter(x=imgActual, lamda=10, theta=65, bw=3, phi=0, asp=0.8, disp=TRUE)
