...
library(wvtool)
library("matrixStats")
imgActual <- readJPEG("C:/Fabric5-ConvertImage.jpg")
img1 <- readJPEG("C:/Fabric5-ConvertImage.jpg")

gaborFilter <- gabor.filter(x=imgActual, lamda=10, theta=90, bw=3, phi=0, asp=0.2, disp=TRUE)
