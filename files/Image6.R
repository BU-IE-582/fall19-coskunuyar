...
library(wvtool)
library("matrixStats")
imgActual <- readJPEG("C:/Fabric6-ConvertImage.jpg")
img1 <- readJPEG("C:/Fabric6-ConvertImage.jpg")

gaborFilter <- gabor.filter(x=imgActual, lamda=10, theta=90, bw=5.5, phi=0, asp=0.8, disp=TRUE)
