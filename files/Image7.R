...
library(wvtool)
library("matrixStats")
imgActual <- readJPEG("C:/Fabric7-ConvertImage.jpg")
img1 <- readJPEG("C:/Fabric7-ConvertImage.jpg")

gaborFilter <- gabor.filter(x=imgActual, lamda=10, theta=5, bw=3.5, phi=0, asp=0.5, disp=TRUE)
